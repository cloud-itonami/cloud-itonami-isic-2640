# Operator Quickstart — Manufacture of consumer electronics

Shortest path from clone to a verified local dry-run for **ISIC 2640** (`cloud-itonami-isic-2640`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2640.git
cd cloud-itonami-isic-2640
```
...
- Blueprint governor key: `consumer-electronics-plant-operations-governor`
- Likely source path: `consumerelec.governor.cljc`
