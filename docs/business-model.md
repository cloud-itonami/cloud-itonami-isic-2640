# Business Model: Manufacture of consumer electronics
...
## Classification
- Repository: `cloud-itonami-isic-2640` ([github.com/cloud-itonami/cloud-itonami-isic-2640](https://github.com/cloud-itonami/cloud-itonami-isic-2640))
- ISIC Rev.5: `2640` — Manufacture of consumer electronics
- Domain: `:consumer-electronics/manufacturing`
- Social impact: :worker-safety :product-safety :consumer-electrical-safety
- Actor: `:consumer-electronics-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :consumer-electronics/manufacturing — who wants
...
One managed tenant (:consumer-electronics/manufacturing):
...
- Do not bypass the `:consumer-electronics-plant-operations-governor` for production decisions.
