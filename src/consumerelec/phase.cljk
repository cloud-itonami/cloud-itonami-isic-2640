(ns consumerelec.phase
  "Phase 0->3 staged rollout for the consumer-electronics
  ...
  consequence (an SMT/assembly/test-bench-equipment maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `consumerelec.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Consumer Electronics Plant Operations Governor verdict to a
