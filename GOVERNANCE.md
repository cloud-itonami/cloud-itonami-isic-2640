...
`cloud-itonami-isic-2640` is an OSS open-business blueprint for
consumer-electronics plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an SMT/assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Consumer Electronics Plant Operations Governor remains independent of the advisor.
...
- bypassing SMT/assembly/test-bench-equipment-control or record policy checks
